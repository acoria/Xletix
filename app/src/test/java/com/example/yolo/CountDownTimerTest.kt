...
class CountDownTimerTest{
    ...
    fun startTimer() {
        ...
        Mockito.verify(observer, Mockito.times(1)).onTimerStarted()
    ...
    fun toggleStateFromPaused() {
        ...
        Mockito.verify(observer, Mockito.times(1)).onTimerResumed()
        Assert.assertEquals(ICountDownTimer.TimerState.RUNNING, countDownTimer.getState())
    }
    ...
    fun toggleStateFromRunning() {
        ...
        Mockito.verify(observer, Mockito.times(1)).onTimerPaused()
    ...
    fun removeObserver(){
        ...
        Mockito.verify(observer, Mockito.times(0)).onTimerStarted()
    }
}